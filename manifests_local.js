const SUMMARY_TEMPLATE_DOC_ID = "12bj2UqQ7w0_lBWFvA25gYxE_MlF_cIBTxUXNW3yQ4fg"

function createLocalManifestByDay() {
  try {
    const templateDocId = SUMMARY_TEMPLATE_DOC_ID
...
function getManifestFileNameByDay(manifestGroup) {
  const manifestFileName = `${formatDate(manifestGroup["Trip Date"], null, "yyyy-MM-dd")} daily trip summary`
